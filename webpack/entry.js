    ...
    resources: {
        en: {
            common: {
                ...
                booking_error: 'Oops, something went wrong! Please try again. If this continues please submit and email to info@meb-verwaltungen.de and include the error shown below.',
        ...
        de: {
            common: {
                ...
                booking_error: 'Ojemine, etwas ist schief gelaufen. Bitte versuchen Sie es ernäut. Wenn es nicht besser wird, bitte ein E-Mail an info@meb-verwaltungen.de schicken.',
